 ...
 */
public class RemoveMoneyMessage extends CoinMessage {
   ...
   */
  public RemoveMoneyMessage (int id, NodeHandle source, Id dest, CoinMessage cm, int amount, Id updated) { 
  ...
  public String toString() {
    return "[RemoveMoneyMessage source: " + getSource() + " amount:" + amount + "]";
  }
